...
import 'package:shared/pages/comments.dart';
...
class _PostState extends State<Post> {
  ...
  addLikeToActivityFeed() {
    //add a notification to the post owner's activity feed only on comments made by others
